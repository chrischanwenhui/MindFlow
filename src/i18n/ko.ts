export const ko = {
  ...
  progressAria: '평가 진행률', memoryTitle: '기억 챌린지', memoryIntro: '몇 초 동안 시퀀스가 보입니다. 사라진 뒤에는 다시 보지 말고 답하세요.', memoryReadyTitle: 'Memory challenge', memoryReadyBody: 'You will see a sequence briefly. Click Ready when you want to reveal it.', readyReveal: 'Ready', memoryHiddenNotice: 'The memory sequence is now hidden. Answer from memory.', timeRemaining: 'Time remaining', timeUpNotice: 'Time is up — answer if you still want, but treat it as late.', memoryReady: '준비됨 — 시퀀스 보기', memorizeThis: '기억하세요', needHelp: '문항 이해에 도움이 필요하신가요?', cognitiveNoBackNotice: 'Cognitive questions do not show correctness during assessment.', memoryProtectionTitle: 'Memory Question Protection', memoryProtectionBody: 'To keep the assessment fair, memory questions cannot be revisited once revealed. Going back will generate a different memory question and your previous memory response will be locked.', regenerateMemoryQuestion: 'Continue', memoryPoolExhausted: 'Memory question pool exhausted for this session.', backPrev: '이전 문항으로',
