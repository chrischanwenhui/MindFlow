export const ja = {
  ...
  mbtiBestFitTemplate: '現在の回答パターンは {personalityTypeEstimate} に傾いています。信頼度：{confidenceLevel}。',
  personalitySignalDisclaimer: 'これらのスコアは回答に基づく内省の手がかりであり、固定的な自己ラベルではありません。',
  scoreBarReflectionHint: '固定的な自己像ではなく、内省のための手がかりとして見てください。',
  mbtiDimensionDetailTemplate: '{poleLabel} への{leanStrength}（{signalLabel}）',
  mbtiDimensionEnergyFocus: 'エネルギーと焦点',
  mbtiDimensionInformationStyle: '情報スタイル',
  mbtiDimensionDecisionAnchor: '意思決定の軸',
  mbtiDimensionStructurePreference: '構造への好み',
  mbtiSlightLean: '弱いシグナル / 混合した根拠',
  mbtiModerateLean: '中程度の傾き',
  mbtiStrongLean: '強い傾き',
  mbtiLowSignal: '弱いシグナル / 混合した根拠',
  mbtiModerateSignal: '中程度のシグナル',
  mbtiStrongSignal: '強いシグナル',
  mbtiPoleE: '外向',
  mbtiPoleI: '内向',
  mbtiPoleS: '感覚',
  mbtiPoleN: '直観',
