export const ja = {
  ...
  memoryReadyTitle: '記憶チャレンジ',
  memoryReadyBody: '短い間だけシーケンスが表示されます。表示する準備ができたら「準備完了」を押してください。',
  readyReveal: '準備完了',
  memoryHiddenNotice: '記憶シーケンスは非表示になりました。記憶を頼りに回答してください。',
  timeRemaining: '残り時間',
  timeUpNotice: '時間切れです。回答はできますが、遅延回答として扱ってください。',
  memoryReady: '準備OK — シーケンスを表示',
  memorizeThis: 'これを覚えてください',
  needHelp: '設問の理解にヘルプが必要ですか？',
  cognitiveNoBackNotice: '認知問題では、実施中に正誤は表示されません。',
  memoryProtectionTitle: '記憶問題の保護',
  memoryProtectionBody: '公平性を保つため、記憶問題は一度表示された後は再閲覧できません。戻ると別の記憶問題に置き換わり、以前の回答は固定されます。',
  regenerateMemoryQuestion: '続行',
  memoryPoolExhausted: 'このセッションでは記憶問題プールを使い切りました。',
  navCancel: 'キャンセル',
  backPrev: '前の質問に戻る',
  resultsTitle: '結果サマリー',
