export const ms = {
  ...
  progressAria: 'Kemajuan penilaian', memoryTitle: 'Cabaran Memori', memoryIntro: 'Anda akan melihat satu urutan selama beberapa saat. Cuba ingat dengan jelas. Apabila hilang, jawab tanpa melihat semula.', memoryReadyTitle: 'Memory challenge', memoryReadyBody: 'You will see a sequence briefly. Click Ready when you want to reveal it.', readyReveal: 'Ready', memoryHiddenNotice: 'The memory sequence is now hidden. Answer from memory.', timeRemaining: 'Time remaining', timeUpNotice: 'Time is up — answer if you still want, but treat it as late.', memoryReady: 'Sedia — Papar Urutan', memorizeThis: 'Ingat ini', needHelp: 'Perlu bantuan memahami soalan?', cognitiveNoBackNotice: 'Cognitive questions do not show correctness during assessment.', memoryProtectionTitle: 'Memory Question Protection', memoryProtectionBody: 'To keep the assessment fair, memory questions cannot be revisited once revealed. Going back will generate a different memory question and your previous memory response will be locked.', regenerateMemoryQuestion: 'Continue', memoryPoolExhausted: 'Memory question pool exhausted for this session.', backPrev: 'Kembali ke soalan sebelumnya',
