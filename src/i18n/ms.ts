export const ms = {
  ...
  heroKicker: 'Reflective profile experience',
  ...
  heroDisclaimer: 'MindFlow is for self-discovery and educational reflection, not diagnosis.',
  ...
  assessmentCategoriesAriaLabel: 'MindFlow reflective assessment categories',
  assessmentCategoriesDisclaimer: 'MindFlow categories are reflective and educational. They are not a diagnosis or a substitute for professional assessment.',
  categoryPersonalityTitle: 'Personality Tendencies',
  categoryPersonalityDesc: 'Explore reflective personality patterns inspired by common trait frameworks, focused on how you tend to think and relate.',
  categoryCareerTitle: 'Career Interest Mapping',
  categoryCareerDesc: 'Identify work themes and environments you may naturally enjoy, for educational career exploration and planning.',
  categoryCognitiveTitle: 'Cognitive-Style Indicators',
  categoryCognitiveDesc: 'Surface learning and problem-solving preferences through lightweight indicators that support self-discovery, not diagnosis.',
  categoryStrengthsTitle: 'Strengths & Growth Areas',
  categoryStrengthsDesc: 'Highlight current strengths and potential growth edges so you can reflect on practical next steps.',
  categoryPatternsTitle: 'Reflective Life Patterns',
  categoryPatternsDesc: 'Notice repeating patterns in your choices and routines to support personal reflection and intentional habits.',
  categoryWorkLearningTitle: 'Work & Learning Preferences',
  categoryWorkLearningDesc: 'Understand preferred collaboration, pacing, and learning conditions to better design your day-to-day environment.',
