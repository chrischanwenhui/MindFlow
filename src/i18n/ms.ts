export const ms = {
  ...
  mbtiBestFitTemplate: 'Corak respons semasa anda cenderung kepada {personalityTypeEstimate}. Tahap keyakinan: {confidenceLevel}.',
  personalitySignalDisclaimer: 'Skor ini ialah isyarat refleksi berdasarkan respons anda, bukan label diri yang tetap.',
  scoreBarReflectionHint: 'Anggap ini sebagai isyarat refleksi, bukan identiti yang tetap.',
  mbtiDimensionDetailTemplate: '{leanStrength} ke arah {poleLabel} ({signalLabel})',
  mbtiDimensionEnergyFocus: 'Tenaga & Fokus',
  mbtiDimensionInformationStyle: 'Gaya Maklumat',
  mbtiDimensionDecisionAnchor: 'Sandaran Keputusan',
  mbtiDimensionStructurePreference: 'Keutamaan Struktur',
  mbtiSlightLean: 'Isyarat rendah / bukti bercampur',
  mbtiModerateLean: 'Kecenderungan sederhana',
  mbtiStrongLean: 'Kecenderungan kuat',
  mbtiLowSignal: 'Isyarat rendah / bukti bercampur',
  mbtiModerateSignal: 'Isyarat sederhana',
  mbtiStrongSignal: 'Isyarat kuat',
  mbtiPoleE: 'Ekstraversi',
  mbtiPoleI: 'Introversi',
  mbtiPoleS: 'Penderiaan',
  mbtiPoleN: 'Intuisi',
  mbtiPoleT: 'Pemikiran',
  mbtiPoleF: 'Perasaan',
  mbtiPoleJ: 'Penilaian',
