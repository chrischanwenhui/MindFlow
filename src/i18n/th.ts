export const th = {
  ...
  progressAria: 'ความคืบหน้าแบบประเมิน', memoryTitle: 'ความท้าทายด้านความจำ', memoryIntro: 'คุณจะเห็นลำดับข้อมูลไม่กี่วินาที พอหายไปแล้วให้ตอบโดยไม่ย้อนดู', memoryReadyTitle: 'Memory challenge', memoryReadyBody: 'You will see a sequence briefly. Click Ready when you want to reveal it.', readyReveal: 'Ready', memoryHiddenNotice: 'The memory sequence is now hidden. Answer from memory.', timeRemaining: 'Time remaining', timeUpNotice: 'Time is up — answer if you still want, but treat it as late.', memoryReady: 'พร้อม — แสดงลำดับ', memorizeThis: 'จดจำสิ่งนี้', needHelp: 'ต้องการความช่วยเหลือในการเข้าใจคำถามไหม?', cognitiveNoBackNotice: 'Cognitive questions do not show correctness during assessment.', memoryProtectionTitle: 'Memory Question Protection', memoryProtectionBody: 'To keep the assessment fair, memory questions cannot be revisited once revealed. Going back will generate a different memory question and your previous memory response will be locked.', regenerateMemoryQuestion: 'Continue', memoryPoolExhausted: 'Memory question pool exhausted for this session.', backPrev: 'กลับไปคำถามก่อนหน้า',
