export const zh = {
  ...
  progressAria: '测评进度', memoryTitle: '记忆挑战', memoryIntro: '你将看到一组序列几秒钟。请尽量记住，消失后在不回看的情况下作答。', memoryReadyTitle: 'Memory challenge', memoryReadyBody: 'You will see a sequence briefly. Click Ready when you want to reveal it.', readyReveal: 'Ready', memoryHiddenNotice: 'The memory sequence is now hidden. Answer from memory.', timeRemaining: 'Time remaining', timeUpNotice: 'Time is up — answer if you still want, but treat it as late.', memoryReady: '准备好了 — 显示序列', memorizeThis: '请记住', needHelp: '需要帮助理解题目吗？', cognitiveNoBackNotice: 'Cognitive questions do not show correctness during assessment.', memoryProtectionTitle: 'Memory Question Protection', memoryProtectionBody: 'To keep the assessment fair, memory questions cannot be revisited once revealed. Going back will generate a different memory question and your previous memory response will be locked.', regenerateMemoryQuestion: 'Continue', memoryPoolExhausted: 'Memory question pool exhausted for this session.', backPrev: '返回上一题',
