export const zh = {
  ...
  mbtiBestFitTemplate: '你当前的回应模式倾向于 {personalityTypeEstimate}。信心程度：{confidenceLevel}。',
  personalitySignalDisclaimer: '这些分数是基于你回应的自我反思信号，并不是固定标签。',
  scoreBarReflectionHint: '请把它理解为一种反思线索，而不是固定身份。',
  mbtiDimensionDetailTemplate: '{leanStrength}，偏向 {poleLabel}（{signalLabel}）',
  mbtiDimensionEnergyFocus: '精力与关注',
  mbtiDimensionInformationStyle: '信息风格',
  mbtiDimensionDecisionAnchor: '决策依据',
  mbtiDimensionStructurePreference: '结构偏好',
  mbtiSlightLean: '信号较弱 / 证据混合',
  mbtiModerateLean: '中等倾向',
  mbtiStrongLean: '明显倾向',
  mbtiLowSignal: '信号较弱 / 证据混合',
  mbtiModerateSignal: '中等信号',
  mbtiStrongSignal: '明显信号',
  mbtiPoleE: '外向',
  mbtiPoleI: '内向',
  mbtiPoleS: '实感',
  mbtiPoleN: '直觉',
