...
const mbti: Question[] = [
  mk2('mbti-ei-1','At the start of a high-stakes initiative, you prefer to…',['Draft an internal position memo before group debate','I'],['Open with a live working session to co-shape direction','E'],'ei'),
  ...
  mk2('mbti-ei-3','In executive updates, you are more likely to…',['Share refined conclusions after personal review','I'],['Share directional thinking to sharpen it with stakeholders','E'],'ei'),
  mk2('mbti-ei-4','When entering a new team, you usually build context by…',['Initiating conversations to map dynamics quickly','E'],['Observing dynamics before actively steering discussions','I'],'ei'),
  ...
  mk2('mbti-ei-6','During planning workshops, you contribute most by…',['Iterating ideas in real time with the room','E'],['Synthesizing quietly, then offering integrated viewpoints','I'],'ei'),
  mk2('mbti-ei-7','When shaping strategy, you first seek clarity through…',['Independent analysis before social alignment','I'],['Interactive alignment before deep individual analysis','E'],'ei'),
  mk2('mbti-ei-8','In cross-functional meetings, your influence style tends to be…',['Frequent verbal engagement to steer direction','E'],['Targeted interventions after listening for signal','I'],'ei'),
  ...
  mk2('mbti-ei-10','When preparing for negotiation, you prefer to…',['Pressure-test decision cases directly with stakeholders','E'],['Rehearse decision cases privately before stakeholder calls','I'],'ei'),
  mk2('mbti-ei-11','In ambiguous leadership moments, you trust…',['Internal reflection before visible action','I'],['Visible engagement to discover the best action','E'],'ei'),
  ...
  mk2('mbti-ei-14','In stakeholder mapping, you are more likely to…',['Engage broadly first, then formalize the readout','E'],['Build a quiet readout first, then engage selectively','I'],'ei'),
  ...
  mk2('mbti-ei-16','At offsites, your productive mode is usually…',['Active participation across many conversations','E'],['Focused one-on-one or small-group exchanges','I'],'ei'),
  mk2('mbti-ei-17','When leading change, you tend to begin with…',['A clear internal thesis to anchor communication','I'],['A broad conversation to surface the thesis','E'],'ei'),
  mk2('mbti-ei-18','During project retrospectives, you contribute by…',['Generating insights through live facilitation','E'],['Offering distilled insights after reflection','I'],'ei'),
  mk2('mbti-ei-19','When onboarding to a new domain, you prefer…',['Independent study before networking heavily','I'],['Relationship-building alongside active study','E'],'ei'),
  mk2('mbti-ei-20','When momentum stalls, your re-acceleration move is to…',['Gather others quickly to build a shared diagnosis','E'],['Clarify your own diagnosis before regrouping others','I'],'ei'),
  mk2('mbti-sn-1','At project kickoff, you anchor decisions on…',['Operational facts already validated in practice','S'],['Emerging patterns and future possibilities','N'],'sn'),
  mk2('mbti-sn-2','In performance reviews, you focus first on…',['Underlying themes and long-term trajectory','N'],['Observable behaviors and measurable outcomes','S'],'sn'),
  mk2('mbti-sn-3','When evaluating a proposal, you prioritize…',['Execution details and real-world constraints','S'],['Conceptual coherence and strategic potential','N'],'sn'),
  ...
  mk2('mbti-sn-5','When briefing others, you usually lead with…',['Concrete specifics and immediate implications','S'],['Framing narrative and future implications','N'],'sn'),
  mk2('mbti-sn-6','For innovation decisions, you trust…',['Signals that suggest an inflection ahead','N'],['Incremental proofs grounded in current reality','S'],'sn'),
  mk2('mbti-sn-7','When interpreting a complicated situation, you first look for…',['Map tangible evidence before extending conclusions','S'],['Symbolic patterns that reveal deeper direction','N'],'sn'),
  mk2('mbti-sn-8','When reviewing dashboards, you are drawn to…',['Trajectory patterns and second-order effects','N'],['Current indicators and operational baselines','S'],'sn'),
  mk2('mbti-sn-9','In roadmap trade-offs, you start from…',['What can be delivered reliably now','S'],['What position creates future optionality','N'],'sn'),
  mk2('mbti-sn-10','When documenting strategy, your style is to…',['Describe guiding principles and design intent','N'],['Specify practical steps with clear dependencies','S'],'sn'),
  mk2('mbti-sn-11','In ambiguous briefings, your first question is usually…',['What do we know with direct evidence?','S'],['What meaning might this signal over time?','N'],'sn'),
  mk2('mbti-sn-12','When coaching teams, you emphasize…',['Interpretive thinking and possibility framing','N'],['Replicable methods and execution discipline','S'],'sn'),
  ...
  mk2('mbti-sn-14','When estimating effort, you draw from…',['Conceptual models and directional analogies','N'],['Comparable precedents and grounded assumptions','S'],'sn'),
  mk2('mbti-sn-15','In postmortems, your analysis centers on…',['Specific process breakdowns and touchpoints','S'],['Systemic dynamics and hidden interaction effects','N'],'sn'),
  mk2('mbti-sn-16','When explaining a recommendation, you prefer…',['Narratives that show strategic significance','N'],['Case examples that show practical feasibility','S'],'sn'),
  mk2('mbti-sn-17','At decision gates, you are most persuaded by…',['Demonstrated reliability in pilot conditions','S'],['A compelling model for where the landscape is heading','N'],'sn'),
  mk2('mbti-sn-18','In execution reviews, you scan first for…',['Meaningful shifts in directional signal','N'],['Variance in concrete outcomes','S'],'sn'),
  ...
  mk2('mbti-tf-1','When two strong proposals conflict, you decide by…',['Applying consistent reasoning across options','T'],['Balancing reasoning with stakeholder impact','F'],'tf'),
  mk2('mbti-tf-2','In tough feedback moments, you optimize for…',['Candor delivered with relational safety','F'],['Clarity, precision, and direct usefulness','T'],'tf'),
  mk2('mbti-tf-3','During escalation, your first move is to…',['Define principles and decision boundaries','T'],['Understand concerns and rebuild trust','F'],'tf'),
  mk2('mbti-tf-4','When policy trade-offs appear, you favor…',['Context-sensitive adjustments for people involved','F'],['Consistency across similar cases','T'],'tf'),
  mk2('mbti-tf-5','In hiring discussions, you weigh more heavily…',['Role fit against objective requirements','T'],['Role fit plus values and team dynamics','F'],'tf'),
  mk2('mbti-tf-6','If a deadline slips, you usually begin by…',['Addressing morale and coordination strain','F'],['Diagnosing systemic causes and controls','T'],'tf'),
  mk2('mbti-tf-7','In resource allocation, your bias is toward…',['Maximizing return through clear prioritization logic','T'],['Protecting commitment and trust while meeting goals','F'],'tf'),
  ...
  mk2('mbti-tf-9','In executive communication, you emphasize…',['Decision logic and consequence modeling','T'],['Human implications and alignment confidence','F'],'tf'),
  ...
  mk2('mbti-tf-11','For difficult organizational changes, you center on…',['Rational design and enforceable expectations','T'],['Adoption readiness and human transition needs','F'],'tf'),
  mk2('mbti-tf-12','When diagnosing team friction, you first inspect…',['Interpersonal signals and perceived respect','F'],['Role clarity and accountability design','T'],'tf'),
  mk2('mbti-tf-13','In vendor decisions, your default is to compare…',['Capability metrics and contractual risk','T'],['Partnership reliability and trust dynamics','F'],'tf'),
  ...
  mk2('mbti-tf-15','If priorities collide across teams, you resolve by…',['Using explicit ranking logic','T'],['Building mutual buy-in before final ranking','F'],'tf'),
  mk2('mbti-tf-16','In crisis updates, your instinct is to provide…',['Reassurance, context, and decision pathways','F'],['Structured facts and decision pathways','T'],'tf'),
  ...
  mk2('mbti-tf-18','For retrospective accountability, you prefer…',['Learning-focused review that preserves engagement','F'],['Clear cause analysis with ownership mapping','T'],'tf'),
  ...
  mk2('mbti-tf-20','When a system performs well but feels misaligned, you focus on…',['Restoring human meaning and authenticity','F'],['Protecting system integrity with clear thresholds','T'],'tf'),
  mk2('mbti-jp-1','For major deliverables, you prefer to…',['Lock milestones early and track against them','J'],['Preserve room for new insight as the situation evolves','P'],'jp'),
  ...
  mk2('mbti-jp-3','In fast-moving projects, you gain confidence from…',['Commitment to a stable operating cadence','J'],['Freedom to pivot methods as new context appears','P'],'jp'),
  mk2('mbti-jp-4','Before launching, you usually…',['Launch with room to iterate in market','P'],['Close open loops and finalize standards','J'],'jp'),
  mk2('mbti-jp-5','In calendar management, you generally…',['Protect planned blocks and pre-commit slots','J'],['Leave adaptive space for emerging priorities','P'],'jp'),
  ...
  mk2('mbti-jp-7','During execution, your workflow is more often…',['Completion-oriented before context switching','J'],['Exploratory and fluid across active threads','P'],'jp'),
  mk2('mbti-jp-8','In governance routines, you favor…',['Flexible reviews timed to decision readiness','P'],['Predictable review cycles and firm cutoffs','J'],'jp'),
  ...
  mk2('mbti-jp-10','For quarterly planning, you start by…',['Defining options and adaptation triggers','P'],['Defining commitments and ownership lines','J'],'jp'),
  mk2('mbti-jp-11','At handoff points, you feel most effective when…',['Expectations are explicit and documented','J'],['Teams can improvise within shared goals','P'],'jp'),
  mk2('mbti-jp-12','When managing dependencies, you lean toward…',['Iterative coordination as conditions evolve','P'],['Early alignment and firm milestones','J'],'jp'),
  mk2('mbti-jp-13','In ambiguous deadlines, your preference is to…',['Set conservative buffers and freeze scope','J'],['Keep scope revisable until constraints clarify','P'],'jp'),
  mk2('mbti-jp-14','When leading sprints, you optimize for…',['Learning velocity and adaptation capacity','P'],['Plan reliability and closure discipline','J'],'jp'),
  mk2('mbti-jp-15','In documentation style, you usually produce…',['Structured plans with defined milestones','J'],['Living documents updated as direction evolves','P'],'jp'),
  mk2('mbti-jp-16','When opportunities appear midstream, you typically…',['Re-evaluate commitments against new upside','P'],['Protect baseline commitments first','J'],'jp'),
  ...
  mk2('mbti-jp-18','When preparing teams, you stress…',['Resourcefulness and in-the-moment judgment','P'],['Role clarity and execution standards','J'],'jp'),
  ...
  mk2('mbti-jp-20','When closing initiatives, you prioritize…',['Rapid transition into the next iteration','P'],['Formal completion and lessons captured','J'],'jp')
];
