...
export const questions: Question[] = [
  ...
  { id: 'stress-1', section: 'stress', hint: 'Choose the option that feels closest most of the time, not what sounds ideal.', prompt: 'When overwhelmed, I most commonly…', options: [{ label: 'Withdraw to reset', value: 'Reset-Oriented', score: 2 }, { label: 'Over-plan details', value: 'Control-Oriented', score: 2 }, { label: 'Seek reassurance and alignment', value: 'Support-Oriented', score: 2 }, { label: 'Become reactive and impatient', value: 'Urgency-Oriented', score: 2 }] },
  { id: 'stress-2', section: 'stress', hint: 'Choose the option that feels closest most of the time, not what sounds ideal.', prompt: 'Under pressure, I worry most about…', options: [{ label: 'Losing control of outcomes', value: 'Control-Oriented', score: 2 }, { label: 'Failing expectations', value: 'Achievement-Driven', score: 2 }, { label: 'Being unsupported', value: 'Support-Oriented', score: 2 }, { label: 'Being misunderstood', value: 'Reset-Oriented', score: 2 }] },
  ...
  { id: 'cog-pattern-1', section: 'cognitive', cognitiveDomain: 'pattern', difficulty: 'easy', hint: 'Look for how the numbers change from one step to the next.', prompt: 'Pattern reasoning: 3, 6, 9, 12, ?', options: [{ label: '14', value: 'pattern', score: 0 }, { label: '15', value: 'pattern', score: 2 }, { label: '16', value: 'pattern', score: 0 }, { label: '18', value: 'pattern', score: 0 }, cognitiveUnknownOption('pattern')] },
  { id: 'cog-pattern-2', section: 'cognitive', cognitiveDomain: 'pattern', difficulty: 'medium', hint: 'Look for how the numbers change from one step to the next.', prompt: 'Pattern reasoning: 1, 4, 9, 16, 25, ?', options: [{ label: '30', value: 'pattern', score: 0 }, { label: '35', value: 'pattern', score: 0 }, { label: '36', value: 'pattern', score: 2 }, { label: '49', value: 'pattern', score: 0 }, cognitiveUnknownOption('pattern')] },
  { id: 'cog-pattern-3', section: 'cognitive', cognitiveDomain: 'pattern', difficulty: 'hard', hint: 'Look for how the numbers change from one step to the next.', prompt: 'Pattern reasoning: 2, 5, 11, 23, 47, ?', options: [{ label: '71', value: 'pattern', score: 0 }, { label: '81', value: 'pattern', score: 0 }, { label: '95', value: 'pattern', score: 2 }, { label: '99', value: 'pattern', score: 0 }, cognitiveUnknownOption('pattern')] },

  { id: 'cog-verbal-1', section: 'cognitive', cognitiveDomain: 'verbal', difficulty: 'easy', hint: 'Find the relationship between the first pair, then apply the same relationship to the second pair.', prompt: 'Verbal reasoning: Compass is to direction as thermometer is to…', options: [{ label: 'Heat', value: 'verbal', score: 0 }, { label: 'Temperature', value: 'verbal', score: 2 }, { label: 'Medicine', value: 'verbal', score: 0 }, { label: 'Weather', value: 'verbal', score: 0 }, cognitiveUnknownOption('verbal')] },
  { id: 'cog-verbal-2', section: 'cognitive', cognitiveDomain: 'verbal', difficulty: 'medium', hint: 'Find the relationship between the first pair, then apply the same relationship to the second pair.', prompt: 'Verbal reasoning: All blue birds can fly. Some flying animals swim. Most reasonable statement?', options: [{ label: 'All blue birds swim', value: 'verbal', score: 0 }, { label: 'Some blue birds may swim', value: 'verbal', score: 2 }, { label: 'No swimming animals fly', value: 'verbal', score: 0 }, { label: 'All birds swim', value: 'verbal', score: 0 }, cognitiveUnknownOption('verbal')] },

  { id: 'cog-numerical-1', section: 'cognitive', cognitiveDomain: 'numerical', difficulty: 'medium', hint: 'Think about the original amount and how each percentage change is applied in sequence.', prompt: 'Numerical reasoning: Price up 10%, then down 10%. Final price vs original?', options: [{ label: 'Higher', value: 'numerical', score: 0 }, { label: 'Lower', value: 'numerical', score: 2 }, { label: 'The same', value: 'numerical', score: 0 }, { label: 'Cannot determine', value: 'numerical', score: 0 }, cognitiveUnknownOption('numerical')] },
  { id: 'cog-numerical-2', section: 'cognitive', cognitiveDomain: 'numerical', difficulty: 'easy', hint: 'Think about the original amount and how each percentage change is applied in sequence.', prompt: 'Numerical reasoning: 4 workers finish in 12h. 8 workers need…', options: [{ label: '3h', value: 'numerical', score: 0 }, { label: '4h', value: 'numerical', score: 0 }, { label: '6h', value: 'numerical', score: 2 }, { label: '8h', value: 'numerical', score: 0 }, cognitiveUnknownOption('numerical')] },

  { id: 'cog-spatial-1', section: 'cognitive', cognitiveDomain: 'spatial', difficulty: 'easy', hint: 'Focus on how shape orientation changes after rotation or folding.', prompt: 'Spatial reasoning: Rotating “b” by 180° most closely looks like…', options: [{ label: 'q', value: 'spatial', score: 2 }, { label: 'd', value: 'spatial', score: 0 }, { label: 'p', value: 'spatial', score: 0 }, { label: 'g', value: 'spatial', score: 0 }, cognitiveUnknownOption('spatial')] },
  { id: 'cog-spatial-2', section: 'cognitive', cognitiveDomain: 'spatial', difficulty: 'medium', hint: 'Focus on how shape orientation changes after rotation or folding.', prompt: 'Spatial reasoning: A rectangle is folded vertically. Which must match on both sides?', options: [{ label: 'Distance from fold line', value: 'spatial', score: 2 }, { label: 'Word orientation', value: 'spatial', score: 0 }, { label: 'Color labels', value: 'spatial', score: 0 }, { label: 'Reading order', value: 'spatial', score: 0 }, cognitiveUnknownOption('spatial')] },

  { id: 'cog-memory-1', section: 'cognitive', cognitiveDomain: 'memory', difficulty: 'easy', hint: 'Keep the sequence order in mind, then locate the requested position carefully.', prompt: 'Working memory: Remember 8 - 3 - 1 - 9 - 4. What was the 4th number?', options: [{ label: '1', value: 'memory', score: 0 }, { label: '9', value: 'memory', score: 2 }, { label: '4', value: 'memory', score: 0 }, { label: '8', value: 'memory', score: 0 }, cognitiveUnknownOption('memory')] },
  { id: 'cog-memory-2', section: 'cognitive', cognitiveDomain: 'memory', difficulty: 'hard', hint: 'Keep the sequence order in mind, then locate the requested position carefully.', prompt: 'Working memory: Remember K - 2 - M - 7 - P - 4. Which symbol came immediately before P?', options: [{ label: '7', value: 'memory', score: 2 }, { label: 'M', value: 'memory', score: 0 }, { label: '4', value: 'memory', score: 0 }, { label: '2', value: 'memory', score: 0 }, cognitiveUnknownOption('memory')] }
];
