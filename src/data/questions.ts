...
const mbti: Question[] = [
  ...
  mk2('mbti-ei-2','When a complex decision is unresolved, your default is to…',['Think through trade-offs privately, then present a recommendation','I'],['Test assumptions in conversation to reach a recommendation','E'],'ei'),
  ...
  mk2('mbti-ei-4','When entering a new team, you usually build context by…',['Observing dynamics before actively steering discussions','I'],['Initiating conversations to map dynamics quickly','E'],'ei'),
  ...
  mk2('mbti-ei-6','During planning workshops, you contribute most by…',['Synthesizing quietly, then offering integrated viewpoints','I'],['Iterating ideas in real time with the room','E'],'ei'),
  ...
  mk2('mbti-ei-8','In cross-functional meetings, your influence style tends to be…',['Targeted interventions after listening for signal','I'],['Frequent verbal engagement to steer direction','E'],'ei'),
  ...
  mk2('mbti-ei-10','When preparing for negotiation, you prefer to…',['Rehearse decision cases privately before stakeholder calls','I'],['Pressure-test decision cases directly with stakeholders','E'],'ei'),
  ...
  mk2('mbti-ei-12','For difficult feedback, your instinct is to…',['Structure points in writing before conversation','I'],['Start the conversation early and refine in dialogue','E'],'ei'),
  ...
  mk2('mbti-ei-14','In stakeholder mapping, you are more likely to…',['Build a quiet readout first, then engage selectively','I'],['Engage broadly first, then formalize the readout','E'],'ei'),
  ...
  mk2('mbti-ei-16','At offsites, your productive mode is usually…',['Focused one-on-one or small-group exchanges','I'],['Active participation across many conversations','E'],'ei'),
  ...
  mk2('mbti-ei-18','During project retrospectives, you contribute by…',['Offering distilled insights after reflection','I'],['Generating insights through live facilitation','E'],'ei'),
  ...
  mk2('mbti-ei-20','When momentum stalls, your re-acceleration move is to…',['Clarify your own diagnosis before regrouping others','I'],['Gather others quickly to build a shared diagnosis','E'],'ei'),
  mk2('mbti-sn-1','At project kickoff, you anchor decisions on…',['Operational facts already validated in practice','S'],['Emerging patterns that indicate future opportunity','N'],'sn'),
  mk2('mbti-sn-2','In performance reviews, you focus first on…',['Observable behaviors and measurable outcomes','S'],['Underlying themes and long-term trajectory','N'],'sn'),
  ...
  mk2('mbti-sn-4','In risk planning, your attention goes first to…',['Known failure points from prior cycles','S'],['New possibilities that could reshape assumptions','N'],'sn'),
  mk2('mbti-sn-5','When briefing others, you usually lead with…',['Concrete specifics and immediate implications','S'],['Framing narrative and directional implications','N'],'sn'),
  mk2('mbti-sn-6','For innovation decisions, you trust…',['Incremental proofs grounded in current reality','S'],['Signals that suggest an inflection ahead','N'],'sn'),
  mk2('mbti-sn-7','In discovery work, you prefer to…',['Map tangible evidence before extending conclusions','S'],['Sketch hypotheses early, then validate selectively','N'],'sn'),
  mk2('mbti-sn-8','When reviewing dashboards, you are drawn to…',['Current indicators and operational baselines','S'],['Trajectory patterns and second-order effects','N'],'sn'),
  ...
  mk2('mbti-sn-10','When documenting strategy, your style is to…',['Specify practical steps with clear dependencies','S'],['Describe guiding principles and design intent','N'],'sn'),
  mk2('mbti-sn-11','In ambiguous briefings, your first question is usually…',['What do we know with direct evidence?','S'],['What pattern might this signal?','N'],'sn'),
  mk2('mbti-sn-12','When coaching teams, you emphasize…',['Replicable methods and execution discipline','S'],['Interpretive thinking and possibility framing','N'],'sn'),
  ...
  mk2('mbti-sn-14','When estimating effort, you draw from…',['Comparable precedents and grounded assumptions','S'],['Conceptual models and directional analogies','N'],'sn'),
  ...
  mk2('mbti-sn-16','When explaining a recommendation, you prefer…',['Case examples that show practical feasibility','S'],['Narratives that show strategic significance','N'],'sn'),
  mk2('mbti-sn-17','At decision gates, you are most persuaded by…',['Demonstrated reliability in pilot conditions','S'],['A compelling model for where the market is heading','N'],'sn'),
  mk2('mbti-sn-18','In execution reviews, you scan first for…',['Variance in concrete deliverables','S'],['Meaningful shifts in directional signal','N'],'sn'),
  mk2('mbti-sn-19','When uncertainty is high, you stabilize by…',['Narrowing to verifiable near-term facts','S'],['Developing projections around likely patterns','N'],'sn'),
  mk2('mbti-sn-20','In planning sessions, you contribute by…',['Grounding choices in practical constraints','S'],['Expanding choices through conceptual reframing','N'],'sn'),
  mk2('mbti-tf-1','When two strong proposals conflict, you decide by…',['Applying consistent criteria across options','T'],['Balancing criteria with stakeholder impact','F'],'tf'),
  mk2('mbti-tf-2','In tough feedback moments, you optimize for…',['Clarity, precision, and direct usefulness','T'],['Candor delivered with relational safety','F'],'tf'),
  mk2('mbti-tf-3','During escalation, your first move is to…',['Define principles and decision boundaries','T'],['Understand concerns and restore trust','F'],'tf'),
  mk2('mbti-tf-4','When policy trade-offs appear, you favor…',['Rule consistency across similar cases','T'],['Context-sensitive adjustments for people involved','F'],'tf'),
  mk2('mbti-tf-5','In hiring discussions, you weigh more heavily…',['Role fit against objective requirements','T'],['Role fit plus team and culture dynamics','F'],'tf'),
  mk2('mbti-tf-6','If a deadline slips, you usually begin by…',['Diagnosing structural causes and controls','T'],['Addressing morale and coordination strain','F'],'tf'),
  mk2('mbti-tf-7','In resource allocation, your bias is toward…',['Maximizing return through clear prioritization logic','T'],['Protecting cohesion while meeting goals','F'],'tf'),
  mk2('mbti-tf-8','When mediating disagreement, you lead with…',['Shared definitions and objective checkpoints','T'],['Shared understanding and relational repair','F'],'tf'),
  mk2('mbti-tf-9','In executive communication, you emphasize…',['Decision logic and consequence modeling','T'],['Stakeholder implications and alignment confidence','F'],'tf'),
  mk2('mbti-tf-10','When reviewing performance concerns, you prioritize…',['Evidence consistency across evaluation points','T'],['Fairness to circumstances and intent','F'],'tf'),
  mk2('mbti-tf-11','For difficult organizational changes, you center on…',['Rational structure and enforceable standards','T'],['Adoption readiness and human transition needs','F'],'tf'),
  mk2('mbti-tf-12','When diagnosing team friction, you first inspect…',['Process clarity and accountability design','T'],['Interpersonal signals and perceived respect','F'],'tf'),
  ...
  mk2('mbti-tf-14','When giving recognition, you tend to focus on…',['Specific outcomes and execution excellence','T'],['Effort context and positive team effect','F'],'tf'),
  mk2('mbti-tf-15','If priorities collide across teams, you resolve by…',['Using explicit ranking logic and governance','T'],['Building mutual buy-in before final ranking','F'],'tf'),
  mk2('mbti-tf-16','In crisis updates, your instinct is to provide…',['Structured facts and decision pathways','T'],['Reassurance, context, and decision pathways','F'],'tf'),
  mk2('mbti-tf-17','When coaching a struggling colleague, you start with…',['A concrete improvement framework','T'],['A conversation on motivation and blockers','F'],'tf'),
  mk2('mbti-tf-18','For retrospective accountability, you prefer…',['Clear cause analysis with ownership mapping','T'],['Learning-focused review that preserves engagement','F'],'tf'),
  ...
  mk2('mbti-tf-20','When handling exceptions, you usually…',['Protect system integrity with clear thresholds','T'],['Protect people outcomes with careful discretion','F'],'tf'),
  mk2('mbti-jp-1','For major deliverables, you prefer to…',['Lock milestones early and track against them','J'],['Keep milestones adjustable as new signal appears','P'],'jp'),
  mk2('mbti-jp-2','When sequencing work, your tendency is to…',['Define order up front to reduce variance','J'],['Re-order dynamically to capture opportunity','P'],'jp'),
  mk2('mbti-jp-3','In fast-moving projects, you gain confidence from…',['Commitment to a stable operating cadence','J'],['Freedom to pivot methods as needed','P'],'jp'),
  mk2('mbti-jp-4','Before launching, you usually…',['Close open loops and finalize standards','J'],['Launch with room to iterate in market','P'],'jp'),
  ...
  mk2('mbti-jp-6','When requirements are unclear, you first…',['Create structure and decision checkpoints','J'],['Run experiments to shape structure','P'],'jp'),
  mk2('mbti-jp-7','During execution, your workflow is more often…',['Completion-oriented before context switching','J'],['Parallel and fluid across active threads','P'],'jp'),
  mk2('mbti-jp-8','In governance routines, you favor…',['Predictable review cycles and firm cutoffs','J'],['Flexible reviews timed to decision readiness','P'],'jp'),
  mk2('mbti-jp-9','When travel or schedules shift, you typically…',['Rebuild a clear plan quickly','J'],['Adapt in motion with lightweight constraints','P'],'jp'),
  mk2('mbti-jp-10','For quarterly planning, you start by…',['Defining commitments and ownership lines','J'],['Defining options and adaptation triggers','P'],'jp'),
  ...
  mk2('mbti-jp-12','When managing dependencies, you lean toward…',['Early alignment and firm checkpoints','J'],['Iterative coordination as conditions evolve','P'],'jp'),
  mk2('mbti-jp-13','In ambiguous deadlines, your preference is to…',['Set conservative buffers and freeze scope','J'],['Keep scope negotiable until constraints clarify','P'],'jp'),
  mk2('mbti-jp-14','When leading sprints, you optimize for…',['Plan reliability and closure discipline','J'],['Learning velocity and adaptation capacity','P'],'jp'),
  mk2('mbti-jp-15','In documentation style, you usually produce…',['Structured plans with defined checkpoints','J'],['Living documents updated as direction evolves','P'],'jp'),
  mk2('mbti-jp-16','When opportunities appear midstream, you typically…',['Protect baseline commitments first','J'],['Re-evaluate commitments against new upside','P'],'jp'),
  ...
  mk2('mbti-jp-18','When preparing teams, you stress…',['Role clarity and execution standards','J'],['Resourcefulness and in-the-moment judgment','P'],'jp'),
  mk2('mbti-jp-19','For personal productivity, you rely more on…',['Systematic routines with defined rituals','J'],['Adaptive rhythms shaped by context','P'],'jp'),
  mk2('mbti-jp-20','When closing initiatives, you prioritize…',['Formal completion and lessons captured','J'],['Rapid transition into the next iteration','P'],'jp')
];
