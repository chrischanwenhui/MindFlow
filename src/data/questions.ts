...
export const questions: Question[] = [
  ...
  { id: 'cog-pattern-1', section: 'cognitive', cognitiveDomain: 'pattern', difficulty: 'easy', prompt: 'Pattern reasoning: 3, 6, 9, 12, ?', options: [{ label: '14', value: 'pattern', score: 0 }, { label: '15', value: 'pattern', score: 2 }, { label: '16', value: 'pattern', score: 0 }, { label: '18', value: 'pattern', score: 0 }] },
  { id: 'cog-pattern-2', section: 'cognitive', cognitiveDomain: 'pattern', difficulty: 'medium', prompt: 'Pattern reasoning: 1, 4, 9, 16, 25, ?', options: [{ label: '30', value: 'pattern', score: 0 }, { label: '35', value: 'pattern', score: 0 }, { label: '36', value: 'pattern', score: 2 }, { label: '49', value: 'pattern', score: 0 }] },
  { id: 'cog-pattern-3', section: 'cognitive', cognitiveDomain: 'pattern', difficulty: 'hard', prompt: 'Pattern reasoning: 2, 5, 11, 23, 47, ?', options: [{ label: '71', value: 'pattern', score: 0 }, { label: '81', value: 'pattern', score: 0 }, { label: '95', value: 'pattern', score: 2 }, { label: '99', value: 'pattern', score: 0 }] },

  { id: 'cog-verbal-1', section: 'cognitive', cognitiveDomain: 'verbal', difficulty: 'easy', prompt: 'Verbal reasoning: Compass is to direction as thermometer is to…', options: [{ label: 'Heat', value: 'verbal', score: 0 }, { label: 'Temperature', value: 'verbal', score: 2 }, { label: 'Medicine', value: 'verbal', score: 0 }, { label: 'Weather', value: 'verbal', score: 0 }] },
  { id: 'cog-verbal-2', section: 'cognitive', cognitiveDomain: 'verbal', difficulty: 'medium', prompt: 'Verbal reasoning: All blue birds can fly. Some flying animals swim. Most reasonable statement?', options: [{ label: 'All blue birds swim', value: 'verbal', score: 0 }, { label: 'Some blue birds may swim', value: 'verbal', score: 2 }, { label: 'No swimming animals fly', value: 'verbal', score: 0 }, { label: 'All birds swim', value: 'verbal', score: 0 }] },

  { id: 'cog-numerical-1', section: 'cognitive', cognitiveDomain: 'numerical', difficulty: 'medium', prompt: 'Numerical reasoning: Price up 10%, then down 10%. Final price vs original?', options: [{ label: 'Higher', value: 'numerical', score: 0 }, { label: 'Lower', value: 'numerical', score: 2 }, { label: 'The same', value: 'numerical', score: 0 }, { label: 'Cannot determine', value: 'numerical', score: 0 }] },
  { id: 'cog-numerical-2', section: 'cognitive', cognitiveDomain: 'numerical', difficulty: 'easy', prompt: 'Numerical reasoning: 4 workers finish in 12h. 8 workers need…', options: [{ label: '3h', value: 'numerical', score: 0 }, { label: '4h', value: 'numerical', score: 0 }, { label: '6h', value: 'numerical', score: 2 }, { label: '8h', value: 'numerical', score: 0 }] },

  { id: 'cog-spatial-1', section: 'cognitive', cognitiveDomain: 'spatial', difficulty: 'easy', prompt: 'Spatial reasoning: Rotating “b” by 180° most closely looks like…', options: [{ label: 'q', value: 'spatial', score: 2 }, { label: 'd', value: 'spatial', score: 0 }, { label: 'p', value: 'spatial', score: 0 }, { label: 'g', value: 'spatial', score: 0 }] },
  { id: 'cog-spatial-2', section: 'cognitive', cognitiveDomain: 'spatial', difficulty: 'medium', prompt: 'Spatial reasoning: A rectangle is folded vertically. Which must match on both sides?', options: [{ label: 'Distance from fold line', value: 'spatial', score: 2 }, { label: 'Word orientation', value: 'spatial', score: 0 }, { label: 'Color labels', value: 'spatial', score: 0 }, { label: 'Reading order', value: 'spatial', score: 0 }] },

  { id: 'cog-memory-1', section: 'cognitive', cognitiveDomain: 'memory', difficulty: 'easy', prompt: 'Working memory: Remember 8 - 3 - 1 - 9 - 4. What was the 4th number?', options: [{ label: '1', value: 'memory', score: 0 }, { label: '9', value: 'memory', score: 2 }, { label: '4', value: 'memory', score: 0 }, { label: '8', value: 'memory', score: 0 }] },
  { id: 'cog-memory-2', section: 'cognitive', cognitiveDomain: 'memory', difficulty: 'hard', prompt: 'Working memory: Remember K - 2 - M - 7 - P - 4. Which symbol came immediately before P?', options: [{ label: '7', value: 'memory', score: 2 }, { label: 'M', value: 'memory', score: 0 }, { label: '4', value: 'memory', score: 0 }, { label: '2', value: 'memory', score: 0 }] }
];
