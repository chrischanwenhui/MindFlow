...
export function App() {
  ...
  {screen === 'start' && <section className="card"><h2>Assessment Start</h2><p>Estimated time: 6–10 minutes. This report is non-diagnostic and for personal reflection.</p><button onClick={startFreshAssessment}>Start Questions</button></section>}
